...
typedef struct _Catalog
{
	...
	char dw1[22];				/* desired with for thumbnails (0 for no resize) */
	char dh1[22];				/* desired height for thumbnails (0 for no resize) */
	char dw2[22];				/* desired with for small thumbnails (0 for no resize) */
	char dh2[22];				/* desired height for small thumbnails (0 for no resize) */
